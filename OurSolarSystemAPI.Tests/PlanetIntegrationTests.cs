...
public class PlanetIntegrationTestAdd
{
    ...
    public async Task AddPlanet_ShouldInsertPlanetIntoDatabase()
    {
        ...
        Assert.Equal("TestPlanet", retrievedPlanet.Name);
        Assert.Equal(5.972e24, retrievedPlanet.Mass);
        Assert.Equal(6371, retrievedPlanet.EquatorialRadius);
    }
