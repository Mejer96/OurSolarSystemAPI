...
namespace OurSolarSystemAPI.Utility
{
    public class HorizonHardcodedData
    {
        ...
        public Star SunData()
        {
            ...
            {
                HorizonId = 10,
                SolarSystemBarycenterHorizonId = 0,
                GravitationalParameter = 132712440041.93938,
                Mass = 1988410,
        ...
        public Planet SaturnData()
        {
            return new Planet
            {
                ...
                Name = "saturn",
                VolumeMeanRadius = 58232,
                Density = 0.687,
                Mass = 5.6834,
                Volume = null,
                EquatorialRadius = 60268, // Removed "± 4"
        ...
        public Planet NeptuneData()
        {
            return new Planet
            {
                ...
                Name = "neptune",
                VolumeMeanRadius = 24624,
                Density = 1.638,
                Mass = 102.409,
                Volume = 6254,
                EquatorialRadius = 24766,
